...
const Header = ({toggleCollapse}:{toggleCollapse():void}) => {
    return (
        <div className="h-[70px] w-full border-b flex px-3 items-center justify-between bg-white">
            <Button onClick={toggleCollapse} icon="FaBars" iconOnly color="hover:bg-gray-100 text-gray-600"/>
            <div className="flex h-full items-center justify-center">
                <Button icon="FaExpand" iconOnly color="hover:bg-gray-100 text-gray-600"/>
                <Button icon="FaRegMoon" iconOnly color="hover:bg-gray-100 text-gray-600"/>
                <span className="relative mr-2">
                    <Button icon="FaRegBell" iconOnly color="hover:bg-gray-100 text-gray-600" iconclassName="animate-wiggle"/>
